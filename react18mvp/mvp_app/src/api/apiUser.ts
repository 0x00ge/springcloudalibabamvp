...
import type { UserForm, UserItem, UserPageConfig } from '@/types/userTypes'
...
const toUserItem = (user: UserDto): UserItem => ({
  id: user.id || '',
  name: user.name,
  phone: user.phone,
...
export const fetchUserPageConfig = async (): Promise<UserPageConfig> => ({
  roleOptions: [
