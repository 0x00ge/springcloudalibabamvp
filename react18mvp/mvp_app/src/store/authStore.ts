...
export const hasValidLogin = () => Boolean(getAccessToken() && !isAccessTokenExpired())

export const loginAction = async (params: LoginParams) => {
  const tokenResult = await login(params)
  setAuthToken(tokenResult)
  return tokenResult
}

export const registerAction = (params: CurrentAuthParams) => register(params)

export const getAuthAction = () => getCurrentAuth()

export const refreshLoginStateAction = async () => {
