-- service-user-0 用户分片库 1：只放 t_user_1 和 t_user_menu_1。
CREATE DATABASE IF NOT EXISTS `mvp_user_1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `mvp_user_1`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户表分片1';

CREATE TABLE IF NOT EXISTS `t_user_menu_1` (
    `id`          CHAR(32)      NOT NULL COMMENT '菜单ID，32位无横杠UUIDv7格式',
    `user_id`     CHAR(32)      NOT NULL COMMENT '用户ID，和 t_user_1 使用同一分片键',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户菜单表分片1';
